        ...
        <div className="mx-auto max-w-7xl px-6 py-12 lg:py-16">
          <div className="flex flex-col items-start justify-between gap-8 rounded-[20px] border border-border bg-background p-6 shadow-sm md:flex-row md:items-center md:p-10">
            <div className="max-w-md">
              <h3 className="text-xl font-extrabold text-foreground tracking-tight sm:text-2xl">
                {t.footer.newsletter}
              </h3>
            ...
            >
              ...
              <Button
                type="submit"
                className="shrink-0 rounded-xl bg-primary px-6 text-sm font-semibold text-primary-foreground shadow-md transition-all hover:bg-primary/95 hover:shadow-lg active:scale-98"
              >
      ...
      <div className="mx-auto max-w-7xl px-6 py-16 lg:py-20">
        <div className="grid gap-12 lg:grid-cols-[1.8fr_repeat(4,1fr)]">
          ...
          <div className="flex flex-col items-start">
            ...
            <p className="mt-5 text-sm leading-relaxed text-muted-foreground max-w-xs font-medium">
              {t.footer.tagline}
            </p>
        ...
        <div className="mx-auto max-w-7xl px-6 py-8">
          <div className="flex flex-col items-center justify-between gap-4 text-sm text-muted-foreground sm:flex-row">
            <p className="text-center font-medium">
              © {new Date().getFullYear()} ALSOUK. {t.footer.rights}
            </p>
