...
export const translations: Record<Lang, Dict> = {
  en: {
    ...
    opportunities: {
      ...
      subtitle:
        "High-priority sourcing and flash deals from vetted Tunisian manufacturers",
    ...
    suppliers: {
      ...
      subtitle:
        "Verified manufacturers and exporters ready to fulfill your orders",
      verified: "Verified",
    ...
    products: {
      ...
      items: [
        ...
        {
          name: "Handcrafted Ceramic Tiles",
          price: "24.800 - 43.400 DT",
          moq: "200 pcs",
          supplier: "Atlas Ceramics",
        },
        ...
        {
          name: "Genuine Leather Goods",
          price: "37.200 - 86.800 DT",
          moq: "100 pcs",
          supplier: "Kairouan Leather",
        },
        {
          name: "Industrial Components",
          price: "46.500 - 139.500 DT",
          moq: "50 pcs",
      ...
      items: [
        {
          ...
          desc: "Every supplier is vetted and verified so you trade with confidence.",
        },
        {
          title: "Secure Trade Assurance",
          desc: "Protected payments and order tracking from quote to delivery.",
        },
        {
          title: "Local & Regional Reach",
          desc: "Deep coverage in Tunisia with growing access across North Africa.",
        },
        {
          title: "Fast RFQ Matching",
          desc: "Get competitive quotes from multiple suppliers within 24 hours.",
        },
        {
          title: "Multilingual Support",
          desc: "Trade seamlessly in Arabic, French and English.",
        },
        {
          title: "Logistics & Export",
          desc: "Integrated shipping and export support for smooth delivery.",
        },
      ],
    },
    stats: {
    ...
    footer: {
      tagline:
        "The premium B2B marketplace connecting Tunisia and North Africa.",
      ...
      support: [
        ...
        { label: "Report Abuse", href: "/help#contact" },
      ],
    ...
    marketplace: {
      ...
      companies: {
        title: "Companies",
        subtitle:
          "Browse verified companies and their storefronts across the marketplace.",
      ...
      products: {
        title: "Products",
        subtitle:
          "Discover products from suppliers across Tunisia and North Africa.",
    ...
    search: {
      ...
      searching: "Searching…",
      prompt:
        "Search suppliers, companies and products across the marketplace.",
    ...
    ai: {
      ...
      send: "Send",
      greeting:
        "Hi! I can help you find suppliers, compare products and prepare RFQs. What are you sourcing today?",
      thinking: "Thinking…",
      error: "Something went wrong. Please try again.",
      disabledTitle: "Assistant coming soon",
      disabledBody:
        "The AI assistant isn't enabled yet. Meanwhile, use search to find suppliers and products, or post an RFQ to get quotes.",
    },
    discovery: {
      title: "Live Sourcing & Factory Tours",
      subtitle:
        "Step inside premium Tunisian manufacturing facilities and verify quality first-hand through curated B2B demonstrations.",
      tabs: {
        all: "All Features",
      ...
      items: [
        {
          title: "Premium Extra Virgin Olive Oil Cold-Pressing Process",
          supplier: "Medina Olive Co.",
          duration: "2:45",
          views: "3.4k views",
          category: "food",
        ...
        {
          title: "Automated Circular Knitting & Yarn Spinning Facility Tour",
          supplier: "Carthage Textiles",
          duration: "3:15",
          views: "1.8k views",
          category: "textiles",
        ...
        {
          title: "Artisanal Pottery Shaping & Hand-Painting Techniques",
          supplier: "Atlas Ceramics",
          duration: "1:50",
          views: "2.1k views",
        ...
        {
          title: "High-Yield Date Sorting & Eco-Friendly Packaging Lines",
          supplier: "Sahara Dates Export",
          duration: "2:10",
          views: "1.2k views",
          category: "food",
        ...
        {
          title:
            "Automated Leather Cutting & Luxury Shoe Assembly Demonstration",
          supplier: "Kairouan Leather",
          duration: "3:40",
          views: "940 views",
          category: "leather",
        ...
        {
          title: "Precision Metal Stamping & Welding Operations Tour",
          supplier: "Tunis Metalworks",
          duration: "4:05",
          views: "1.5k views",
          category: "machinery",
    ...
    export: {
      ...
      subtitle:
        "Source from a modern, world-class hub situated at the crossroads of Europe, Africa, and the Middle East.",
      items: [
        {
          title: "Unmatched Proximity",
          desc: "Located just 140km from southern Europe, facilitating extremely short shipping lead times.",
          stat: "1-3 Days",
          statLabel: "Transit to EU",
        },
        {
          title: "Duty-Free Trade Agreements",
          desc: "Benefit from free trade agreements with the European Union, UK, and major African nations.",
          stat: "0%",
          statLabel: "Customs Tariffs",
        },
        {
          title: "Skilled & Vetted Craftsmanship",
          desc: "Access a rich heritage of precision engineering, handcrafts, and high-quality food production.",
          stat: "100%",
          statLabel: "Vetted Standards",
        },
        {
          title: "Modern Deep-Water Ports",
          desc: "Highly connected maritime network with world-class facilities and streamlined export processing.",
          stat: "7+",
          statLabel: "Active Commercial Ports",
        },
      ],
    },
    home: {
      ...
      liveEmptyBody:
        "No company is streaming or has scheduled a session yet. Check back soon.",
      activityTitle: "Live marketplace activity",
      activitySubtitle:
        "Verified suppliers and buyers trading across the region right now.",
      ...
      opportunitiesSubtitle:
        "Buyers are sourcing these products now — send your quote and win the order.",
      buyerIn: "Buyer in",
      ...
      videosSubtitle:
        "See factories and products in action, then source in one tap.",
      watchNow: "Watch",
      companiesTag: "Recommended for you",
      companiesTitle: "Companies to discover",
      companiesSubtitle:
        "Handpicked verified companies matched to regional demand.",
      visitStore: "Visit store",
      followLabel: "Follow",
      tradeShowsTag: "Trade shows",
      tradeShowsTitle: "Upcoming exhibitions",
      tradeShowsSubtitle:
        "Meet suppliers in person at the region's leading B2B events.",
      register: "Register interest",
      tradeShowItems: [
        {
          name: "Tunis Industrial Expo",
          date: "12–15 Sep 2026",
          city: "Tunis",
        },
        {
          name: "North Africa Food & Agri",
          date: "03–06 Oct 2026",
          city: "Sfax",
        },
        {
          name: "Maghreb Textile Summit",
          date: "18–20 Nov 2026",
          city: "Casablanca",
        },
      ],
      ...
      aiCtaSubtitle:
        "Describe what you need and get matched with verified suppliers and ready-to-send RFQs in seconds.",
      ...
      videoItems: [
        {
          title: "Inside our olive oil press",
          supplier: "Medina Olive Co.",
          views: "12.4K",
        },
        {
          title: "Cotton weaving in Monastir",
          supplier: "Carthage Textiles",
          views: "8.1K",
        },
        {
          title: "Date sorting & packing line",
          supplier: "Sahara Dates Export",
          views: "15.7K",
        },
        {
          title: "Handcrafted ceramic firing",
          supplier: "Atlas Ceramics",
          views: "6.9K",
        },
      ],
    ...
    soon: {
      ...
      messagesBody:
        "Chat directly with suppliers about quotes and orders. Messaging is on the way — for now, send a request and suppliers will reply to you.",
      accountTitle: "Your account",
      accountBody:
        "Manage your company profile, saved suppliers and requests here. Accounts are coming soon — keep sourcing in the meantime.",
    ...
    auth: {
      ...
      chooseRoleDesc:
        "Select your account type to personalize your experience. You can browse both ways, but this tells other businesses your primary focus.",
      buyer: "Buyer",
      buyerDesc:
        "I want to source products, submit RFQs, and connect with Tunisian suppliers.",
      supplier: "Supplier / Manufacturer",
      supplierDesc:
        "I want to showcase my products, receive RFQs, and export to regional/global markets.",
      ...
      passwordRecoveryDesc:
        "You followed a password reset link. Choose a new password to finish and continue to your account.",
      phoneAlreadyRegistered:
        'An account with this phone number already exists. Try signing in, or use "Forgot password" if it\'s yours.',
      emailAlreadyRegistered:
        'An account with this email already exists. Try signing in, or use "Forgot password" if it\'s yours.',
    ...
    exhibitions: {
      ...
      subtitle:
        "Discover virtual trade shows, browse unique company pavilions, and negotiate directly with elite local producers.",
      organizer: "Organizer",
      ...
      requestMeetingDesc:
        "Submit your preferred slot to book a direct virtual discussion with their export sales team.",
      ...
      meetingNotesPlaceholder:
        "Describe your business needs, volume interest, or meeting goals...",
      ...
      boothNotFoundDesc:
        "This exhibition booth doesn't exist, is no longer active, or is archived.",
  ...
  fr: {
    ...
    opportunities: {
      ...
      subtitle:
        "Sourcing prioritaire et offres flash des fabricants tunisiens vérifiés",
    ...
    suppliers: {
      ...
      subtitle:
        "Fabricants et exportateurs vérifiés prêts à traiter vos commandes",
      verified: "Vérifié",
    ...
    products: {
      ...
      subtitle:
        "Produits de qualité sélectionnés auprès des meilleurs fournisseurs",
      ...
      items: [
        ...
        {
          name: "Tissu de coton premium",
          price: "6.510 - 10.540 DT",
          moq: "1 000 m",
          supplier: "Carthage Textiles",
        },
        {
          name: "Carreaux en céramique artisanaux",
          price: "24.800 - 43.400 DT",
          moq: "200 pcs",
          supplier: "Atlas Ceramics",
        },
        ...
        {
          name: "Articles en cuir véritable",
          price: "37.200 - 86.800 DT",
          moq: "100 pcs",
          supplier: "Kairouan Leather",
        },
    ...
    rfq: {
      ...
      title:
        "Dites-nous ce dont vous avez besoin, recevez des devis rapidement",
      subtitle:
      ...
      step2desc:
        "Les fournisseurs vérifiés envoient des devis et échantillons.",
    ...
    why: {
      ...
      subtitle:
        "La manière fiable de commercer en Tunisie et en Afrique du Nord",
      items: [
        {
          title: "Fournisseurs vérifiés",
          desc: "Chaque fournisseur est contrôlé et vérifié pour commercer en confiance.",
        },
        {
          title: "Transactions sécurisées",
          desc: "Paiements protégés et suivi des commandes du devis à la livraison.",
        },
        {
          title: "Portée locale & régionale",
          desc: "Forte couverture en Tunisie et accès croissant en Afrique du Nord.",
        },
        {
          title: "Correspondance RFQ rapide",
          desc: "Recevez des devis compétitifs de plusieurs fournisseurs sous 24 h.",
        },
        {
          title: "Support multilingue",
          desc: "Commercez facilement en arabe, français et anglais.",
        },
        {
          title: "Logistique & export",
          desc: "Support d'expédition et d'export intégré pour une livraison fluide.",
        },
      ],
    },
    stats: {
    ...
    testimonials: {
      ...
      subtitle:
        "Découvrez les acheteurs et fournisseurs qui grandissent avec ALSOUK",
      items: [],
    },
    footer: {
      tagline:
        "La place de marché B2B premium qui relie la Tunisie et l'Afrique du Nord.",
      newsletter: "Restez informé",
      newsletterDesc:
        "Recevez des analyses commerciales et des alertes fournisseurs.",
      ...
      support: [
        ...
        { label: "Signaler un abus", href: "/help#contact" },
      ],
    ...
    marketplace: {
      ...
      companies: {
        title: "Entreprises",
        subtitle:
          "Parcourez les entreprises vérifiées et leurs boutiques sur la place de marché.",
      ...
      products: {
        title: "Produits",
        subtitle:
          "Découvrez les produits de fournisseurs de Tunisie et d'Afrique du Nord.",
    ...
    search: {
      ...
      searching: "Recherche…",
      prompt:
        "Recherchez fournisseurs, entreprises et produits sur la marketplace.",
    ...
    profile: {
      ...
      addSocialHandles:
        "Ajouter les réseaux sociaux (Facebook, LinkedIn, etc.)",
    ...
    ai: {
      ...
      send: "Envoyer",
      greeting:
        "Bonjour ! Je peux vous aider à trouver des fournisseurs, comparer des produits et préparer des devis. Que recherchez-vous ?",
      thinking: "Réflexion…",
      error: "Une erreur est survenue. Veuillez réessayer.",
      disabledTitle: "Assistant bientôt disponible",
      disabledBody:
        "L'assistant IA n'est pas encore activé. En attendant, utilisez la recherche pour trouver des fournisseurs et des produits, ou publiez une demande de devis.",
    },
    discovery: {
      title: "Sourcing en Direct & Visites d'Usines",
      subtitle:
        "Entrez dans les usines tunisiennes de premier plan et vérifiez la qualité de fabrication via des démonstrations B2B exclusives.",
      tabs: {
        all: "Tout afficher",
      ...
      items: [
        {
          title: "Processus de pressage à froid d'huile d'olive extra vierge",
          supplier: "Medina Olive Co.",
          duration: "2:45",
          views: "3.4k vues",
          category: "food",
        ...
        {
          title: "Visite de l'usine de tricotage circulaire et de filature",
          supplier: "Carthage Textiles",
          duration: "3:15",
          views: "1.8k vues",
          category: "textiles",
        ...
        {
          title: "Techniques de façonnage et peinture manuelle de poteries",
          supplier: "Atlas Ceramics",
          duration: "1:50",
          views: "2.1k vues",
          category: "handicrafts",
        ...
        {
          title: "Lignes de tri de dattes et emballage éco-responsable",
          supplier: "Sahara Dates Export",
          duration: "2:10",
          views: "1.2k vues",
          category: "food",
        ...
        {
          title:
            "Démo de découpe automatisée de cuir et assemblage de chaussures",
          supplier: "Kairouan Leather",
          duration: "3:40",
          views: "940 vues",
          category: "leather",
        ...
        {
          title:
            "Visite des opérations d'emboutissage et de soudage de précision",
          supplier: "Tunis Metalworks",
          duration: "4:05",
          views: "1.5k vues",
          category: "machinery",
    ...
    export: {
      ...
      subtitle:
        "Approvisionnez-vous auprès d'un pôle moderne idéalement situé au carrefour de l'Europe, de l'Afrique et du Moyen-Orient.",
      items: [
        {
          title: "Proximité Incomparable",
          desc: "Situé à seulement 140 km du sud de l'Europe, permettant des délais de livraison extrêmement courts.",
          stat: "1-3 Jours",
          statLabel: "Transit vers l'UE",
        },
        {
          title: "Accords de Libre-Échange",
          desc: "Bénéficiez d'accords de libre-échange avec l'Union européenne, le Royaume-Uni et les pays d'Afrique.",
          stat: "0%",
          statLabel: "Tarifs Douaniers",
        },
        {
          title: "Savoir-Faire Qualifié & Audité",
          desc: "Accédez à un riche patrimoine d'ingénierie, d'artisanat et de production alimentaire de qualité.",
          stat: "100%",
          statLabel: "Normes Vérifiées",
        },
        {
          title: "Ports Commerciaux Modernes",
          desc: "Réseau maritime hautement connecté doté d'installations de classe mondiale pour simplifier l'export.",
          stat: "7+",
          statLabel: "Ports Commerciaux",
        },
      ],
    },
    home: {
      ...
      liveSubtitle:
        "Sessions produits en direct animées par des entreprises vérifiées.",
      liveBadge: "EN DIRECT",
      ...
      liveEmptyBody:
        "Aucune entreprise ne diffuse ni n'a programmé de session. Revenez bientôt.",
      activityTitle: "Activité en direct de la marketplace",
      activitySubtitle:
        "Fournisseurs vérifiés et acheteurs qui commercent dans la région en ce moment.",
      ...
      trendingSubtitle:
        "Les produits les plus recherchés par les acheteurs cette semaine.",
      hotBadge: "Populaire",
      opportunitiesTag: "Demandes d'achat ouvertes",
      opportunitiesTitle: "Opportunités d'affaires",
      opportunitiesSubtitle:
        "Des acheteurs sourcent ces produits maintenant — envoyez votre devis et remportez la commande.",
      buyerIn: "Acheteur à",
      sourcing: "recherche",
      ...
      videosSubtitle:
        "Découvrez usines et produits en action, puis sourcez en un geste.",
      watchNow: "Regarder",
      companiesTag: "Recommandé pour vous",
      companiesTitle: "Entreprises à découvrir",
      companiesSubtitle:
        "Entreprises vérifiées sélectionnées selon la demande régionale.",
      visitStore: "Voir la boutique",
      followLabel: "Suivre",
      tradeShowsTag: "Salons professionnels",
      tradeShowsTitle: "Salons à venir",
      tradeShowsSubtitle:
        "Rencontrez des fournisseurs en personne aux principaux événements B2B de la région.",
      register: "Manifester son intérêt",
      tradeShowItems: [
        {
          name: "Tunis Industrial Expo",
          date: "12–15 sept. 2026",
          city: "Tunis",
        },
        {
          name: "North Africa Food & Agri",
      ...
      aiCtaSubtitle:
        "Décrivez votre besoin et soyez mis en relation avec des fournisseurs vérifiés et des demandes de devis prêtes à envoyer en quelques secondes.",
      ...
      videoItems: [
        {
          title: "Dans notre pressoir à huile d'olive",
          supplier: "Medina Olive Co.",
          views: "12,4K",
        },
        {
          title: "Tissage du coton à Monastir",
          supplier: "Carthage Textiles",
          views: "8,1K",
        },
        {
          title: "Ligne de tri et d'emballage de dattes",
          supplier: "Sahara Dates Export",
          views: "15,7K",
        },
        {
          title: "Cuisson de céramique artisanale",
          supplier: "Atlas Ceramics",
          views: "6,9K",
        },
      ],
    ...
    soon: {
      ...
      messagesTitle: "Messages",
      messagesBody:
        "Discutez directement avec les fournisseurs de vos devis et commandes. La messagerie arrive bientôt — envoyez une demande et les fournisseurs vous répondront.",
      accountTitle: "Votre compte",
      accountBody:
        "Gérez votre profil d'entreprise, vos fournisseurs enregistrés et vos demandes ici. Les comptes arrivent bientôt — continuez votre sourcing en attendant.",
    ...
    auth: {
      ...
      chooseRoleDesc:
        "Sélectionnez votre type de compte pour personnaliser votre expérience. Vous pouvez naviguer des deux manières, mais cela indique aux autres entreprises votre objectif principal.",
      buyer: "Acheteur",
      buyerDesc:
        "Je souhaite sourcer des produits, soumettre des RFQ et entrer en contact avec des fournisseurs tunisiens.",
      supplier: "Fournisseur / Fabricant",
      supplierDesc:
        "Je souhaite présenter mes produits, recevoir des RFQ et exporter vers les marchés régionaux/globaux.",
      ...
      passwordRecoveryDesc:
        "Vous avez suivi un lien de réinitialisation. Choisissez un nouveau mot de passe pour continuer vers votre compte.",
      phoneAlreadyRegistered:
        'Un compte existe déjà avec ce numéro de téléphone. Essayez de vous connecter, ou utilisez "Mot de passe oublié" si c\'est le vôtre.',
      emailAlreadyRegistered:
        'Un compte existe déjà avec cet e-mail. Essayez de vous connecter, ou utilisez "Mot de passe oublié" si c\'est le vôtre.',
      signupRateLimited:
      ...
      profileSubtitle:
        "Gérez les informations de votre compte B2B et vos préférences",
    ...
    exhibitions: {
      ...
      subtitle:
        "Découvrez des salons virtuels, visitez des stands d'entreprises exclusifs et négociez en direct avec les meilleurs producteurs.",
      ...
      noExhibits:
        "Aucune pièce exposée exclusive n'est présentée pour l'instant.",
      ...
      requestMeetingDesc:
        "Proposez un créneau horaire pour réserver un entretien en direct avec l'équipe commerciale export.",
      meetingDate: "Date souhaitée",
      meetingTime: "Tranche horaire souhaitée",
      meetingNotes: "Ordre du jour / Pièces d'intérêt",
      meetingNotesPlaceholder:
        "Décrivez vos besoins, volumes souhaités ou objectifs de la réunion...",
      ...
      boothNotFoundDesc:
        "Ce stand d'exposition n'existe pas, n'est plus actif ou est archivé.",
  ...
  ar: {
    ...
    opportunities: {
      title: "فرص اليوم",
      subtitle:
        "فرص توريد ذات أولوية عالية وعروض خاطفة من مصنعين تونسيين معتمدين",
      badge: "توريد خاطف",
    ...
    products: {
      ...
      items: [
        ...
        {
          name: "منتجات جلدية أصلية",
          price: "37.200 - 86.800 د.ت",
          moq: "100 قطعة",
          supplier: "القيروان للجلود",
        },
        {
          name: "مكوّنات صناعية",
          price: "46.500 - 139.500 د.ت",
          moq: "50 قطعة",
      ...
      items: [
        {
          ...
          desc: "يتم فحص كل مورّد والتحقق منه لتتاجر بثقة تامة.",
        },
        {
          title: "تأمين تجاري آمن",
          desc: "مدفوعات محمية وتتبّع للطلبات من العرض حتى التسليم.",
        },
        {
          title: "انتشار محلي وإقليمي",
          desc: "تغطية واسعة في تونس ووصول متنامٍ في شمال إفريقيا.",
        },
        {
          title: "مطابقة سريعة للطلبات",
          desc: "احصل على عروض تنافسية من عدة موردين خلال 24 ساعة.",
        },
        {
          title: "دعم متعدد اللغات",
          desc: "تاجر بسلاسة بالعربية والفرنسية والإنجليزية.",
        },
        {
          title: "الخدمات اللوجستية والتصدير",
          desc: "دعم متكامل للشحن والتصدير لتسليم سلس.",
        },
      ],
    },
    stats: {
    ...
    footer: {
      ...
      support: [
        ...
        { label: "الإبلاغ عن إساءة", href: "/help#contact" },
      ],
    ...
    ai: {
      ...
      send: "إرسال",
      greeting:
        "مرحبًا! يمكنني مساعدتك في العثور على الموردين ومقارنة المنتجات وإعداد طلبات عروض الأسعار. ما الذي تبحث عنه اليوم؟",
      thinking: "جارٍ التفكير…",
      error: "حدث خطأ ما. يرجى المحاولة مرة أخرى.",
      disabledTitle: "المساعد قريبًا",
      disabledBody:
        "مساعد الذكاء الاصطناعي غير مُفعّل بعد. في هذه الأثناء، استخدم البحث للعثور على الموردين والمنتجات، أو انشر طلب عرض سعر.",
    },
    discovery: {
      title: "استكشاف الموردين وجولات المصانع المباشرة",
      subtitle:
        "ادخل إلى أفضل مرافق التصنيع التونسية وتحقق من الجودة مباشرة عبر عروض فيديو حصرية لمشاهدة الإنتاج الفعلي.",
      tabs: {
        all: "كل العروض",
      ...
      items: [
        {
          title: "عملية العصر البارد لزيت الزيتون البكر الممتاز",
          supplier: "شركة مدينة للزيتون",
          duration: "2:45",
          views: "3.4k مشاهدة",
          category: "food",
        ...
        {
          title: "جولة في مصنع الغزل والنسيج الدائري المؤتمت",
          supplier: "قرطاج للمنسوجات",
          duration: "3:15",
          views: "1.8k مشاهدة",
          category: "textiles",
        ...
        {
          title: "تقنيات تشكيل وتلوين الخزف الفخاري يدوياً",
          supplier: "أطلس للخزف",
          duration: "1:50",
          views: "2.1k مشاهدة",
          category: "handicrafts",
        ...
        {
          title: "خطوط فرز التمور وتغليفها الصديق للبيئة",
          supplier: "الصحراء لتصدير التمور",
          duration: "2:10",
          views: "1.2k مشاهدة",
          category: "food",
        ...
        {
          title: "استعراض لقص الجلد الآلي وتجميع الأحذية الفاخرة",
          supplier: "القيروان للجلود",
          duration: "3:40",
          views: "940 مشاهدة",
          category: "leather",
        ...
        {
          title: "جولة في عمليات كبس المعادن واللحام عالية الدقة",
          supplier: "تونس للأشغال المعدنية",
          duration: "4:05",
          views: "1.5k مشاهدة",
          category: "machinery",
    ...
    export: {
      ...
      subtitle:
        "استورد من مركز تصنيع حديث ذي مستوى عالمي يقع في مفترق الطرق بين أوروبا وأفريقيا والشرق الأوسط.",
      items: [
        {
          title: "قرب جغرافي لا مثيل له",
          desc: "تقع تونس على بعد 140 كم فقط من جنوب أوروبا، مما يضمن أوقات شحن قياسية وقصيرة للغاية.",
          stat: "1-3 أيام",
          statLabel: "العبور إلى أوروبا",
        },
        {
          title: "اتفاقيات التجارة الحرة",
          desc: "استفد من الإعفاء الجمركي الكامل بفضل اتفاقيات الشراكة مع الاتحاد الأوروبي والمملكة المتحدة وأفريقيا.",
          stat: "0%",
          statLabel: "التعريفات الجمركية",
        },
        {
          title: "مهارة يدوية معتمدة وعريقة",
          desc: "وصول إلى إرث غني من الدقة الهندسية والحرف الفنية والأغذية الزراعية الفاخرة المعتمدة دولياً.",
          stat: "100%",
          statLabel: "معايير موثقة",
        },
        {
          title: "موانئ تجارية حديثة",
          desc: "شبكة نقل بحري متكاملة مع بنية تحتية وموانئ تجارية مجهزة لتسريع إجراءات التصدير.",
          stat: "7+ موانئ",
          statLabel: "نشطة للتصدير",
        },
      ],
    },
    home: {
      ...
      opportunitiesSubtitle:
        "يبحث المشترون عن هذه المنتجات الآن — أرسل عرضك واربح الطلب.",
      buyerIn: "مشترٍ في",
      sourcing: "يبحث عن",
      quoteNow: "قدّم عرضاً",
      openLabel: "مفتوح",
      ...
      videosSubtitle:
        "شاهد المصانع والمنتجات أثناء العمل، ثم اطلب بنقرة واحدة.",
      watchNow: "شاهد",
      ...
      tradeShowsSubtitle:
        "قابل الموردين شخصياً في أبرز فعاليات الأعمال في المنطقة.",
      register: "سجّل اهتمامك",
      tradeShowItems: [
        { name: "معرض تونس الصناعي", date: "12–15 سبتمبر 2026", city: "تونس" },
        {
          name: "معرض شمال إفريقيا للغذاء والزراعة",
          date: "03–06 أكتوبر 2026",
          city: "صفاقس",
        },
        {
          name: "قمة المغرب للنسيج",
          date: "18–20 نوفمبر 2026",
          city: "الدار البيضاء",
        },
      ],
      ...
      aiCtaSubtitle:
        "صِف ما تحتاجه واحصل على موردين موثّقين وطلبات عروض أسعار جاهزة للإرسال في ثوانٍ.",
      ...
      videoItems: [
        {
          title: "داخل معصرة زيت الزيتون لدينا",
          supplier: "Medina Olive Co.",
          views: "12.4K",
        },
        {
          title: "نسج القطن في المنستير",
          supplier: "Carthage Textiles",
          views: "8.1K",
        },
        {
          title: "خط فرز وتعبئة التمور",
          supplier: "Sahara Dates Export",
          views: "15.7K",
        },
        {
          title: "حرق الخزف اليدوي",
          supplier: "Atlas Ceramics",
          views: "6.9K",
        },
      ],
    ...
    soon: {
      ...
      messagesBody:
        "تواصل مباشرة مع المورّدين حول عروض الأسعار والطلبات. المراسلة قادمة قريباً — أرسل طلبك وسيرد عليك المورّدون.",
      accountTitle: "حسابك",
      accountBody:
        "أدر ملف شركتك والمورّدين المحفوظين وطلباتك من هنا. الحسابات قادمة قريباً — واصل البحث عن المنتجات في هذه الأثناء.",
    ...
    auth: {
      ...
      chooseRoleDesc:
        "حدد نوع حسابك لتخصيص تجربتك. يمكنك التصفح بكلا الطريقتين، ولكن هذا يخبر الشركات الأخرى بتركيزك الأساسي.",
      buyer: "مشتري",
      buyerDesc:
        "أريد توريد المنتجات، وتقديم طلبات عروض الأسعار، والتواصل مع الموردين التونسيين.",
      supplier: "مورد / مصنع",
      supplierDesc:
        "أريد عرض منتجاتي، واستلام طلبات عروض الأسعار، والتصدير إلى الأسواق الإقليمية والعالمية.",
      ...
      passwordRecoveryDesc:
        "لقد اتبعت رابط إعادة تعيين كلمة المرور. اختر كلمة مرور جديدة للمتابعة إلى حسابك.",
      phoneAlreadyRegistered:
        'يوجد حساب مسجّل بهذا الرقم مسبقًا. جرّب تسجيل الدخول، أو استخدم "نسيت كلمة المرور" إذا كان الرقم لك.',
      emailAlreadyRegistered:
        'يوجد حساب مسجّل بهذا البريد الإلكتروني مسبقًا. جرّب تسجيل الدخول، أو استخدم "نسيت كلمة المرور" إذا كان البريد لك.',
    ...
    exhibitions: {
      title: "معارض السوق",
      subtitle:
        "اكتشف المعارض التجارية الافتراضية، وتصفح أجنحة الشركات المميزة، وتفاوض مباشرة مع نخبة المنتجين المحليين.",
      ...
      requestMeetingDesc:
        "قدّم تفاصيل وتفضيلات الوقت لحجز مناقشة افتراضية مباشرة مع فريق مبيعات التصدير.",
      meetingDate: "التاريخ المفضل",
      meetingTime: "الفترة الزمنية المفضلة",
      meetingNotes: "جدول أعمال الاجتماع / المعروضات التي تهمك",
      meetingNotesPlaceholder:
        "صف متطلبات عملك، حجم الطلب المتوقع، أو أهداف الاجتماع...",
      ...
      boothNotFoundDesc:
        "جناح المعرض هذا غير موجود، أو لم يعد نشطًا، أو تم أرشفته.",
      ...
      noExhibitorsMatchedDesc:
        "يرجى التحقق من الكلمة المفتاحية أو اختيار فئة أخرى.",
